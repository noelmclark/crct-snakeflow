...
rule get_aut_bcf:
    ...
    output:
        bcf="results/bcf/aut-all.bcf",
        tbi="results/bcf/aut-all.bcf.csi"
    conda:
        "../envs/bcftools.yaml"
    log:
        "results/logs/hard_filtering/aut_bcf/aut-all.log"
    benchmark:
        "results/benchmarks/hard_filtering/aut_bcf/aut-all.bmk"
    shell:
...
#### the following is essentially a copy of all the rules above but run on the vcf sections including all callable sites, not just variant sites ####
