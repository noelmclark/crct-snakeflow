...
rule make_plink_bed_rcnv_dvs:
    ...
    output:
        bed="results/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=7480
    log:
        "results/logs/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1.log",
    benchmark:
        "results/benchmarks/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1.bmk",
    shell:
...
rule make_plink_pca_rcnv_dvs:
    ...
    params:
        pfile="results/plink/missingness/aut-bisnps-no5indel-rcnv-by-dvs",
    output:
        pca="results/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1-pca",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1-pca.log",
    benchmark:
        "results/benchmarks/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1-pca.bmk",
    shell:
        " plink2 --pfile {params.pfile} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_phylip_rcnv_dvs:
    ...
    params:
        pfile="results/plink/missingness/aut-bisnps-no5indel-rcnv-by-dvs",
    output:
        phylip="results/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1.log",
    benchmark:
        "results/benchmarks/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-dvs-nooutlier-MAC1.bmk",
    shell:
        " plink2 --pfile {params.pfile} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_gt_count_rcnv_dvs:
    input:
        ...
        acount="results/plink/allele-count/aut-bisnps-no5indel-rcnv-by-dvs.acount",
    output:
        gcount="results/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-dvs-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-dvs-MAC1.log",
    benchmark:
        "results/benchmarks/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-dvs-MAC1.bmk",
    shell:
        " plink2 --bcf {input.bcf} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_plink_bed_rcnv_cnv:
    ...
    output:
        bed="results/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=7480
    log:
        "results/logs/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1.log",
    benchmark:
        "results/benchmarks/plink/bed/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1.bmk",
    shell:
        " plink2 --pfile {params.pfile} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_plink_pca_rcnv_cnv:
    ...
    params:
        pfile="results/plink/missingness/aut-bisnps-no5indel-rcnv-by-cnv",
    output:
        pca="results/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1-pca",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1-pca.log",
    benchmark:
        "results/benchmarks/plink/pca/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1-pca.bmk",
    shell:
        " plink2 --pfile {params.pfile} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_phylip_rcnv_cnv:
    ...
    params:
        pfile="results/plink/missingness/aut-bisnps-no5indel-rcnv-by-cnv",
    output:
        phylip="results/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1.log",
    benchmark:
        "results/benchmarks/plink/phylip/MAC1/aut-bisnps-no5indel-rcnv-by-cnv-nooutlier-MAC1.bmk",
    shell:
        " plink2 --pfile {params.pfile} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
...
rule make_gt_count_rcnv_cnv:
    input:
        ...
        acount="results/plink/allele-count/aut-bisnps-no5indel-rcnv-by-cnv.acount",
    output:
        gcount="results/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-cnv-MAC1",
    conda:
        "../envs/plink.yaml"
    resources:
        mem_mb=11220
    log:
        "results/logs/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-cnv-MAC1.log",
    benchmark:
        "results/benchmarks/plink/gt-count/MAC1/{sample}-aut-bisnps-no5indel-rcnv-by-cnv-MAC1.bmk",
    shell:
        " plink2 --bcf {input.bcf} "
        " --set-missing-var-ids @:#[b37]\$r,\$a "
        " --allow-extra-chr "
