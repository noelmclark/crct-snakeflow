...
rule import_genomics_db_by_chromo:
    input:
        gvcfs=expand("results/calling/gvcf_sections/{s}/{{chromo}}.g.vcf.gz", s=sample_list),
        gvcf_idx=expand("results/calling/gvcf_sections/{s}/{{chromo}}.g.vcf.gz.tbi", s=sample_list),
    output:
...
rule import_genomics_db_by_scaffold_group:
    input:
        gvcfs=expand("results/calling/gvcf_sections/{s}/{{scaff_group}}.g.vcf.gz", s=sample_list),
        gvcf_idx=expand("results/calling/gvcf_sections/{s}/{{scaff_group}}.g.vcf.gz.tbi", s=sample_list),
    output:
