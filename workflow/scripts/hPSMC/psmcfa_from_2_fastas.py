...
### Julia Owen-Ramos shared her updated script which matched the syntax I had also updated to play better with python v3.12.4 ###
### I also used chatgpt to debug some other errors, including adding seq="" at line 32 ###
### Script to combine two fastas into a single psmcfa file ###

import sys, os
from optparse import OptionParser

bin = 100  # Default bin size
min = 50   # Minimum number of sites covered by both individuals to return a result
